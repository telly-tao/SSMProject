...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title" id="NoPermissionModalLabel">职位修改</h4>
        </div>
        <div class="modal-body">
            <form id="editForm" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="item form-group">
                    <label class="col-form-label col-md-3 col-sm-3 label-align">选择部门</label>
                    <div class="col-md-6 col-sm-6 ">
                        <select id ="edit_deptid" name="edit_deptid" class="form-control" id="edit_status" >
...
<script>
    function edit() {
        ...
        //提交表单请求
        $.ajax({
            url: "${pageContext.request.contextPath}/area/position/edit.action",
            type: "post",
            data: {
                id: $("#edit_id").val(),
                name: $("#edit_name").val(),
                companyid: $("#edit_deptid").val()
            },
            dataType: "json",
    ...
    function  loadEditData(id) {
        $.ajax({
            url: "${pageContext.request.contextPath}/area/position/query.action",
            type: "post",
            data: {
                id: id,
            },
    ...
    function  loadDeptDataEdit() {
        $.ajax({
            url: "${pageContext.request.contextPath}/area/position/queryDept.action",
            type: "post",
            data: {
            },
            dataType: "json",
            success: function (data) {
                var bb =$(document).find("#edit_deptid");
