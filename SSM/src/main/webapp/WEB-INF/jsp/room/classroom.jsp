...
<div class="modal fade" id="addModal" tabindex="-1" aria-hidden="true">
    <jsp:include page="classroomAdd.jsp"></jsp:include>
</div>
<!-- 修改页面 -->
<div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
    <jsp:include page="classroomEdit.jsp"></jsp:include>
</div>
...
<script>
    ...
    function loadDataTables() {
        $('#dataTables').DataTable({
            ...
            ajax: {
                "type": "POST",
                "url": "${pageContext.request.contextPath}/room/classroom/dataTables.action",
                "dataType": "json",
                "data": function (data) {
    ...
    function remove(id) {
        layer.confirm('确认要删除吗？', {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/room/classroom/remove.action",
                type: "post",
                data: {
                    id: id,
                },
