...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title" id="NoPermissionModalLabel">课程体系新增</h4>
        </div>
        <div class="modal-body">
            <form id="addForm" data-parsley-validate class="form-horizontal form-label-left">
                <div class="item form-group">
                    <label class="col-form-label col-md-3 col-sm-3 label-align">课程体系/技术方向名称</label>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                        <input type="text" id="add_filedir" name="add_filedir" class="form-control">
                    </div>
                </div>
                <div class="item form-group">
...
<script>
    function add() {
        ...
        //提交表单请求
        $.ajax({
            url: "${pageContext.request.contextPath}/setup/setup/add.action",
            type: "post",
            data: {
                name: $("#add_name").val(),
                filedir: $("#add_filedir").val(),
