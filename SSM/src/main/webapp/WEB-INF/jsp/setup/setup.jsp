                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <div class="col-md-2 form-group has-feedback">
                                    <input type="text" class="form-control has-feedback-left" id="id" placeholder="体系编号">
                                </div>
                                <div class="col-md-2 form-group has-feedback">
...
<div class="modal fade" id="addModal" tabindex="-1" aria-hidden="true">
    <jsp:include page="setupAdd.jsp"></jsp:include>
</div>
<!-- 修改页面 -->
<div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
    <jsp:include page="setupEdit.jsp"></jsp:include>
</div>
...
<script>
    ...
    function loadDataTables() {
        $('#dataTables').DataTable({
            ...
            ajax: {
                "type": "POST",
                "url": "${pageContext.request.contextPath}/setup/setup/dataTables.action",
                "dataType": "json",
                "data": function (data) {
    ...
    function remove(id) {
        layer.confirm('确认要删除吗？', {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/setup/setup/remove.action",
                type: "post",
                data: {
                    id: id,
                },
