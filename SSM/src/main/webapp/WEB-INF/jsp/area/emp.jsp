                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <div class="col-md-2 form-group has-feedback">
                                    <input type="text" class="form-control has-feedback-left" id="id" placeholder="工号">
                                </div>
                                <div class="col-md-2 form-group has-feedback">
...
<div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
    <jsp:include page="empEdit.jsp"></jsp:include>
</div>

<!-- 导入页面 -->
<div class="modal fade" id="impModal" tabindex="-1" aria-hidden="true">
    <jsp:include page="empImp.jsp"></jsp:include>
</div>
...
<script>
    ...
    function loadDataTables() {
        $('#dataTables').DataTable({
            ...
            ajax: {
                "type": "POST",
                "url": "${pageContext.request.contextPath}/area/emp/dataTables.action",
                "dataType": "json",
                "data": function (data) {
