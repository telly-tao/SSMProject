...
<head>
    ...
    <!-- select2 -->
    <link href="${pageContext.request.contextPath}/vendors/select2/dist/css/select2.css" rel="stylesheet">
</head>
                ...
                <div class="page-title">
                    ...
                    <div class="title_right">
                        <div class="pull-right">
                            ...
                            <button onclick="showImp()" class="btn btn-success">导入</button>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
    <jsp:include page="userEdit.jsp"></jsp:include>
</div>

<!-- 导入页面 -->
<div class="modal fade" id="impModal" tabindex="-1" aria-hidden="true">
    <jsp:include page="userImp.jsp"></jsp:include>
</div>
...
<!-- select2 -->
<script src="${pageContext.request.contextPath}/vendors/select2/dist/js/select2.full.js"></script>
<!--文档就绪函数-->
<script>
    $(function () {
        loadDataTables();
    ...
    function loadDataTables() {
        $('#dataTables').DataTable({
            ...
            ajax: {
                "type": "POST",
                "url": "${pageContext.request.contextPath}/sys/user/dataTables.action",
                "dataType": "json",
                "data": function (data) {
            ...
            'aoColumns': [{
                ...
                'bSortable': false,
                "render": function (data, type, row, meta) {
                    let roleNames = "<div class='text-wrap width-200'>";
                    for (let i = 0; i < data.length; i++) {
                        let role = data[i];
                        if (role != null) roleNames += role.name + "&nbsp;";
                    }
                    return roleNames + "</div>";
                }
            }, {
                'sTitle': '状态',
                'mDataProp': 'status',
    ...
    function remove(id) {
        layer.confirm('确认要删除吗？', {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/sys/user/remove.action",
                type: "post",
                data: {
                    id: id,
                },
