...
<div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
    <jsp:include page="positionEdit.jsp"></jsp:include>
</div>
...
<script>
    ...
    function loadDataTables() {
        $('#dataTables').DataTable({
            ...
            ajax: {
                "type": "POST",
                "url": "${pageContext.request.contextPath}/area/position/dataTables.action",
                "dataType": "json",
                "data": function (data) {
    ...
    function remove(id) {
        layer.confirm('确认要删除吗？', {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/area/position/remove.action",
                type: "post",
                data: {
                    id: id,
                },
