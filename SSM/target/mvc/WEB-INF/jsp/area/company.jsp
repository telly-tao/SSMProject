...
<div class="modal fade" id="addModal" tabindex="-1" aria-hidden="true">
    <jsp:include page="companyAdd.jsp"></jsp:include>
</div>
<!-- 修改页面 -->
<div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
    <jsp:include page="companyEdit.jsp"></jsp:include>
</div>
...
<script>
    ...
    function loadDataTables() {
        $('#dataTables').DataTable({
            ...
            ajax: {
                "type": "POST",
                "url": "${pageContext.request.contextPath}/area/company/dataTables.action",
                "dataType": "json",
                "data": function (data) {
    ...
    function remove(id) {
        layer.confirm('确认要删除吗？', {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/area/company/remove.action",
                type: "post",
                data: {
                    id: id,
                },
